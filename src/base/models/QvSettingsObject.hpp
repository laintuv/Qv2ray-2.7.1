...
#undef _VARNAME_VASSETSPATH_
    ...
    struct Qv2rayConfig_Advanced
    {
        ...
        JSONSTRUCT_COMPARE(Qv2rayConfig_Advanced, setAllowInsecure, testLatencyPeriodically, disableSystemRoot, testLatencyOnConnected)
        JSONSTRUCT_REGISTER(Qv2rayConfig_Advanced, F(setAllowInsecure, testLatencyPeriodically, disableSystemRoot, testLatencyOnConnected))
    };
